...
test_case_path = project_path + "/src/testCase"
...
email_name = "testLitLiveIOS@126.com"  # 发件人名称
email_password = "LZNKLYXTZYVODYIO" #"testLiveLive1234"  # 发件人登录密码
email_To = 'testLitLiveIOS@126.com' # 收件人
